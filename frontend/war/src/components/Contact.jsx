            ...
            <div className="flex justify-center mt-9 bg-gray-200 text-gray-800">
                <div className="text-center mt-4 mr-5 ml-5">
                    <form onSubmit={sendEmail} className="bg-white space-y-4 p-6 text-center w-full max-w-md shadow-top shadow-gray-800 rounded-2xl hover:animate-button-push hover:shadow-xl hover:shadow-gray-700">
                        ...
                        <input placeholder='שם' type="text" name="name" value={name} onChange={e => setName(e.target.value)} style={{ direction: 'rtl' }} className="mb-2 bg-gray-300 rounded-lg p-2 text-center" />
                        <input placeholder='מייל' type="email" name="email" value={email} onChange={e => setEmail(e.target.value)} style={{ direction: 'rtl' }} className="mb-2 bg-gray-300 rounded-lg p-2 text-center" />
                        <textarea placeholder='דברו אלינו' name="message" value={message} onChange={e => setMessage(e.target.value)} style={{ direction: 'rtl' }} className="mb-2 bg-gray-300 rounded-lg p-2 text-center" /><br />
