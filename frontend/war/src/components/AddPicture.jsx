...
const AddPicture = () => {
    ...
    return (
        <div className="bg-gray-200 h-screen">
            ...
            <nav className="hidden lg:flex md:flex sm:flex left-0 top-0  bg-gray-200 justify-center items-center text-xl text-gray-800 h-[80px] mt-4 sm:mt-0 cursor-pointer space-x-20">
                {!user && (
                    <>
