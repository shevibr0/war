...
const Sidebar = () => {
    ...
    return (
        <>
            <aside className={`${toggle ? "left-0" : "-left-28"} fixed top-0 bg-gray-800 border-r border-gray-700 p-10 w-28 min-h-screen flex flex-col justify-between z-10 transition-all duration-300`}>
