        ...
        <div className="bg-gray-200 h-screen font-sans">
            ...
            <div className='bg-gray-200'>
                ...
                <div className="flex items-center justify-center  flex-wrap ">
                    <div className="ml-9 mr-9 w-[578px] h-[800px] lg:w-[678px] lg:h-96 lg:mr-2 md:w-[678px] md:h-[440px] sm:w-[578px] sm:h-[540px] mt-4   p-1 text-center text-gray-600 text-m font-light leading-[42.67px] tracking-wider bg-white border border-gray-700 ">
