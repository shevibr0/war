    ...
    return (
        <div className="bg-gray-200 h-screen font-sans">
            <>
                ...
                <h3 className='flex justify-center mt-2 mb-2 text-gray-800 text-xs'>"המידע אודות הנופלים מתעדכן מידי יום מהאתר "דבר</h3>
                <h3 className='flex justify-center text-gray-800 text-xs underline'><a href="https://www.davar1.co.il/" target="_blank" rel="noopener noreferrer">לאתר דבר</a></h3>
