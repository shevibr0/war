...
const HomePage = () => {
    ...
    return (
        <div className="bg-gray-200 h-screen font-sans">
            ...
            <h3 className='flex justify-center mt-2 mb-2 text-gray-800 text-xs'> <a className='underline mr-1' href="https://www.davar1.co.il/" target="_blank" rel="noopener noreferrer"> דבר</a> המידע מתעדכן מידי יום מהאתר  </h3>
        </div>
    )
}
